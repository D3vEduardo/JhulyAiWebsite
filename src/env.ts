...
const envSchema = z.object({
  PRIVATE_OPENROUTER_API_KEY: z.string().min(1, "PRIVATE_OPENROUTER_API_KEY é obrigatório"),
...
if (!parsed.success) {
  ...
  throw new Error("Variáveis de ambiente inválidas ou ausentes. Corrija o arquivo .env.local antes de iniciar a aplicação.");
}
