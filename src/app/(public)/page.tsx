    ...
    <main className="w-screen min-h-dvh flex flex-col items-center justify-center">
      ...
      <header className="w-screen h-full p-3 md:p-10 flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col items-center justify-center w-full md:w-8/10 lg:w-73/100 text-center">
          <div
            className="w-screen flex flex-col items-center justify-center g-0">
            <h1
              className="text-2xl md:text-[42px] lg:text-6xl text-text-primary overflow-hidden pb-0 md:pb-1.5">
            ...
            >
              ...
              <ZoopText
                className="bg-button-secondary rounded-xl md:rounded-2xl px-2 lg:mt-2 h-full"
                texts={[
                  "novo.",
                  "incrível.",
                  "fantástico.",
